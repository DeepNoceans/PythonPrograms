...
def add_oil():
    global oil_group, new_oil, num_oils
...
while True:
    ...
    print_text(font, 380, 0, f"Oils: {str(num_oils)}")
    if game_over:
        print_text(font, 330, 250, "G A M E   O V E R")
